...
@section('page-title', 'Add Department Stream')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Department Stream</h2>
        <p class="admin-page-subtitle">Create academic faculty or department stream.</p>
    </div>
</div>

<form method="POST" action="{{ route('admin.department-streams.store') }}">
    @csrf
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="faculty_label" id="faculty_label" value="{{ old('faculty_label') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                               required placeholder="Social Science"
