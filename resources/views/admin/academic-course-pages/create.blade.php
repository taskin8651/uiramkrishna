...
@section('page-title', 'Add Academic Course Page')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Academic Course Page</h2>
        <p class="admin-page-subtitle">Create page content for academic course sections.</p>
    </div>
</div>

<form method="POST" action="{{ route('admin.academic-course-pages.store') }}">
    @csrf
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="css_prefix" id="css_prefix" value="{{ old('css_prefix') }}"
                               placeholder="ssc"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="kicker_text" id="kicker_text" value="{{ old('kicker_text', 'Academics') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="hero_title" id="hero_title" value="{{ old('hero_title') }}"
                               placeholder="Senior Secondary Courses"
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="summary_label" id="summary_label" value="{{ old('summary_label', 'Course Overview') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        <i class="fas fa-heading icon"></i>
                        <input type="text" name="summary_title" id="summary_title" value="{{ old('summary_title') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="summary_description" id="summary_description" rows="5"
                              class="field-textarea">{{ old('summary_description') }}</textarea>
                </div>
                            ...
                            <div class="col-md-5">
                                <div class="input-icon-wrap">
                                    ...
                                    <input type="text" name="summary_stats[{{ $i }}][value]"
                                           value="{{ old('summary_stats.' . $i . '.value') }}"
                                           placeholder="3" class="field-input">
                                </div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="input-icon-wrap">
                                    ...
                                    <input type="text" name="summary_stats[{{ $i }}][label]"
                                           value="{{ old('summary_stats.' . $i . '.label') }}"
                                           placeholder="Streams" class="field-input">
                                </div>
                            </div>
                        </div>
                    @endfor
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="note_title" id="note_title" value="{{ old('note_title', 'Eligibility') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="note_description" id="note_description" rows="3"
                              class="field-textarea">{{ old('note_description') }}</textarea>
                </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        <i class="fas fa-tag icon"></i>
                        <input type="text" name="panel_label" id="panel_label" value="{{ old('panel_label', 'Available Courses') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        <i class="fas fa-heading icon"></i>
                        <input type="text" name="panel_title" id="panel_title" value="{{ old('panel_title') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="field-group">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="text" name="button_text" id="button_text" value="{{ old('button_text', 'Admission Details') }}"
                                       class="field-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="field-group">
                            ...
                            <div class="input-icon-wrap">
                                <i class="fas fa-link icon"></i>
                                <input type="text" name="button_url" id="button_url" value="{{ old('button_url', 'admission.html') }}"
                                       class="field-input">
                            </div>
                        </div>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="table_label" id="table_label" value="{{ old('table_label', 'Official Course Table') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        <i class="fas fa-heading icon"></i>
                        <input type="text" name="table_title" id="table_title" value="{{ old('table_title', 'Course Name, Duration & Eligibility') }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="field-group">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="text" name="download_button_text" id="download_button_text" value="{{ old('download_button_text', 'Downloads') }}"
                                       class="field-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="field-group">
                            ...
                            <div class="input-icon-wrap">
                                <i class="fas fa-link icon"></i>
                                <input type="text" name="download_button_url" id="download_button_url" value="{{ old('download_button_url', 'downloads.html') }}"
                                       class="field-input">
                            </div>
                        </div>
                    </div>
