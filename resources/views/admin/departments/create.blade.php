...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">Create a stream-wise department or subject.</p>
    </div>
</div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="department_stream_id"
                            ...
                            @foreach($streams as $id => $stream)
                                <option value="{{ $id }}" {{ old('department_stream_id') == $id ? 'selected' : '' }}>
                                    {{ $stream }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">Blank छोड़ने पर slug department name से auto create होगा.</p>
                    @endif
                </div>
